...
@Component({
  selector: 'app-loan-application-general',
  templateUrl: './loan-application-general.component.html',
  styleUrls: ['./loan-application-general.component.css']
})
export class LoanApplicationGeneralComponent implements OnInit {
  toastr: any;
 ...
 loan: Loan = new Loan();
  ...
  save()  { 
    this.loanService.genloan(this.loan).subscribe(data => {
      console.log(data)
      this.loan = new Loan();
      this.gotoList();
    }, 

...
public class loanDto {
	...
	//	@NotEmpty(message="applicant_name cannot be empty")
		...
		// @NotEmpty(message="job_title cannot be empty")
			...
			public loanDto(long loanId, int customer, int admin,
			...
			public String toString() {
				return "loanDto [LoanId=" + LoanId + ", customer=" + customer + ", admin=" + admin + ", applicant_name="
						...
						+ ", place_of_work=" + place_of_work + ", job_title=" + job_title + ", anual_income="
						+ anual_income + ", loanAmount=" + loanAmount + ", loanType=" + loanType + ", adminLoanAproval="
						+ adminLoanAproval + ", acceptancebutton=" + acceptancebutton + "]";
			}

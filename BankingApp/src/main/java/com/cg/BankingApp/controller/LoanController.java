...
public class LoanController {
	...
	// Adding loan in database with or without customer
	...
	public Loan addLoan(@Valid @RequestBody  Loan add)
	{
		...
		System.out.println("loan application received from an unknowns customer");
		return add;
	}
	
	//creating loan application with customer details
